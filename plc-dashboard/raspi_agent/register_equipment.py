...
from db_utils import get_cpu_serial_number, get_mac_address, agent_api_headers
...
try:
    r = requests.post(f"{FLASK_SERVER}/api/register", json=data, headers=agent_api_headers(), timeout=5)
    r.raise_for_status()
