...
**関連ドキュメント:**
- `_docs/plc-knowledge/protocols.md` - PLCプロトコル詳細
- `_docs/plc-knowledge/plc-manufacturers.md` - メーカー別レジスタ仕様
...
**関連ドキュメント:**
- `_docs/plc-knowledge/endianness.md` - Big-Endian必須の理由
- `_docs/plc-knowledge/timeout-settings.md` - タイムアウト設定ベストプラクティス
...
**関連ドキュメント:**
- `_docs/features/local-buffering.md` - ローカルバッファリング機能詳細（未作成）
...
- `_docs/decisions/data-archiving-strategy.md` - 階層化アーカイブ戦略
...
**関連ドキュメント:**
- `_docs/architecture/frontend.md` - フロントエンドアーキテクチャ詳細
...
- `_docs/architecture/database.md` - データベース設計詳細
- `_docs/architecture/realtime-communication.md` - リアルタイム通信詳細
