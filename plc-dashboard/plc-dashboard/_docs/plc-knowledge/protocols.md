...
|---------|----------|----------------|-------------|
| キーエンス | Modbus TCP | `pymodbus` | `plc-dashboard/raspi_agent/plc_drivers/keyence_driver.py` |
| オムロン | FINS | `fins` | `plc-dashboard/raspi_agent/plc_drivers/omron_driver.py` |
| 三菱電機 | MC Protocol | `pymcprotocol` | `plc-dashboard/raspi_agent/plc_drivers/mitsubishi_driver.py` |
| シーメンス | S7 Protocol | (未実装) | - |
...
### 実装ファイル
`plc-dashboard/raspi_agent/plc_drivers/keyence_driver.py`
...
### 実装ファイル
`plc-dashboard/raspi_agent/plc_drivers/omron_driver.py`
...
### 実装ファイル
`plc-dashboard/raspi_agent/plc_drivers/mitsubishi_driver.py`
